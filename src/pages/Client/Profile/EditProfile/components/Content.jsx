      ...
      {activeTab === 'security' && (
        <Layout className={styles['form-design-layout']}>
          <Content className={styles['form-design-content']}>
            ...
            <form className={styles['form-design-form']}>
              <div className={styles['form-item']}>
                <label htmlFor="current-password">Mật khẩu hiện tại</label>
                <Input.Password id="current-password" placeholder="Nhập mật khẩu hiện tại" />
              </div>
              <div className={styles['form-item']}>
                <label htmlFor="new-password">Mật khẩu mới</label>
                <Input.Password id="new-password" placeholder="Nhập mật khẩu mới" />
              </div>
              <div className={styles['form-item']}>
                <label htmlFor="confirm-password">Xác nhận mật khẩu mới</label>
                <Input.Password id="confirm-password" placeholder="Xác nhận mật khẩu mới" />
              </div>
              <div className={styles['form-actions']}>
                <Checkbox>Lưu mật khẩu mới</Checkbox>
